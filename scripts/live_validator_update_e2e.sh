...
remote "$CANARY_VM" 'sudo systemctl enable --now cathedral-validator-canary-update.timer && sudo systemctl restart cathedral-validator-canary-update.timer'
...
remote "$STABLE_VM" 'sudo systemctl enable --now cathedral-validator-update.timer && sudo systemctl restart cathedral-validator-update.timer'
