...
remote "$CANARY_VM" "test \"\$(sudo systemctl show cathedral-validator-canary-update.timer -p ActiveState --value)\" = active && test \"\$(sudo systemctl show cathedral-validator-canary-update.timer -p SubState --value)\" = waiting && test \"\$(sudo systemctl show cathedral-validator-canary-update.timer -p ConditionResult --value)\" = yes"
...
remote "$STABLE_VM" "test \"\$(sudo systemctl show cathedral-validator-update.timer -p ActiveState --value)\" = active && test \"\$(sudo systemctl show cathedral-validator-update.timer -p SubState --value)\" = waiting && test \"\$(sudo systemctl show cathedral-validator-update.timer -p ConditionResult --value)\" = yes"
